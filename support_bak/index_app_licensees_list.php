...
$pageSubTitle = "Click practitioner NAME to edit their information. Click any column header below to sort. To un or re-license, check box and confirm by clicking button at bottom of page.";
  ...
  <div class='clearAll'></div>  
	...
	if(isset($scopeMsg) && $scopeMsg > '' ) {
	   ...
	   echo "</table>";			   
		...
		echo "<tfoot>";
		echo "<tr><th colspan='8'>Total: " . $shown . "</th></tr>\n";
		echo "</tfoot>";
        echo "<THEAD>";		
		echo "<tr>";
