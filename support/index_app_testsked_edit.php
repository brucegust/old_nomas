        ...
        <div class='testsked_form_add_box'>
            ...
            <form id="testsked_add" action='<?php echo "{$_SERVER['PHP_SELF']}"?>' method="POST" novalidate>
                ...
                <select name="testnum">
                   ...
                   switch ($testnum) {
				      case "2" :
					     $displaynum = "Reliability Test #2";
						 break;
					  case "3" :	 
					     $displaynum = "Reliability Test #3";
						 break;    
					  case "4" :	 
					     $displaynum = "Re-Licensing Test #1";
						 break; 
					  case "5" :	 
					     $displaynum = "Re-Licensing Test #2";
						 break; 						    	
					  default:
					     $displaynum = $testnum;	 					              						 
				   }
				   ?>
                   <option value="<?php echo $displaynum;?>"><?php echo $displaynum;?></option>                   
