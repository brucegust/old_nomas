...
<div id="playground">
   ...
   <div id='nomas_content'>    
      <div id='nomas_page_headlines'>
		...
		<br><br>
		<span style="font-family: Verdana, Geneva, sans-serif; font-size:10pt; margin-left:12px; line-height:20px;">FYI: You may want to make nine copies of the NOMAS<sup>&reg;</sup> Scoring Sheet for each of the babies that you will be reviewing in the video. </span>
       ...
       <div id='column_left_wide'>          
          ...
          <table style='margin-left:auto;margin-right:auto;'> 
			 <tr>
				<td class="pageSubTitle"><u>Talk #3</u></td>
			</tr>
			<tr>
				<td>&nbsp;<br><br></td>
			</tr>
			<tr>
				<td class="videoCell">Talk #3 Handout: click <a href="http://www.nomasinternational.org/olceu/olceu_pdf/od1_talk_three.pdf" target="_blank" style="font-family:Arial, sans-serif; font-size:10pt; font-weight:bold; color:#333; text-decoration:underline;">here</a> to view the handout for Talk #3</td>
			</tr>
			<tr>
				<td>&nbsp;<br></td>
			</tr>
			<tr>
				<td class="videoCell">Talk #3 Video...<br><br></td>
			</tr>
             <tr>
                <td>
                   <div id='vidBox_3' style='color:red;'>Please install the Flash Plugin</div>	
                      <script type="text/javascript">
                    
                      jwplayer('vidBox_3').setup({
                         'id': 'playerID',
                         'width': '640',
                         'height': '520',
                         'file': 'http://www.nomasinternational.org/_video/od1_talk_three.mp4',
                         'provider': 'http',
                         'image': '',
			...
			<tr>
				<td>
					<table style="width:100%;">
						...
						<tr>
							<td class="videoCell" style="text-align:left;"><a href="series_four_video_2.php?the_sid=<?php echo $_GET['the_sid'];?>&the_at=<?php echo $_GET['the_at'];?>" style="color:#000000; text-decoration:none;"><span style="font-size:18px;">&#9668;</span>&nbsp;Talk #2</a></td>
							<td class="videoCell" style="text-align:right;"><a href="series_four_video_4.php?the_sid=<?php echo $_GET['the_sid'];?>&the_at=<?php echo $_GET['the_at'];?>" style="color:#000000; text-decoration:none;">Talk #4</a>&nbsp;<span style="font-size:18px;">&#9658;</span></td>
						</tr>
						<tr>
							<td colspan="2"><hr></td>
						</tr>
