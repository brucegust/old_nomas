...
if(!isset($_GET['video']))
{
	header("location:video_no_url.php");
	exit();
}

if($_GET['video']==1)
{
	$video_short_title="Flaccid Video #1";
	$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #1";	
}
	elseif($_GET['video']==2)
	{
		$video_short_title="Flaccid Video #2";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #2";	
	}
	elseif($_GET['video']==3)
	{
		$video_short_title="Flaccid Video #3";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #3";	
	}
	elseif($_GET['video']==4)
	{
		$video_short_title="Flaccid Video #4";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #4";	
	}
	elseif($_GET['video']==5)
	{
		$video_short_title="Flaccid Video #5";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #5";	
	}
	elseif($_GET['video']==6)
	{
		$video_short_title="Flaccid Video #6";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #6";	
	}
	elseif($_GET['video']==7)
	{
		$video_short_title="Flaccid Video #7";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #7";	
	}
	elseif($_GET['video']==8)
	{
		$video_short_title="Flaccid Video #8";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #8";	
	}
	elseif($_GET['video']==9)
	{
		$video_short_title="Flaccid Video #9";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #9";	
	}
	elseif($_GET['video']==10)
	{
		$video_short_title="Flaccid Video #10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video #10";		
	}
	elseif($_GET['video']==11)
	{
		$video_short_title="Retracted Video #1";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #1";		
	}
	elseif($_GET['video']==12)
	{
		$video_short_title="Retracted Video #2";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #2";		
	}
	elseif($_GET['video']==13)
	{
		$video_short_title="Retracted Video #3";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #3";		
	}
	elseif($_GET['video']==14)
	{
		$video_short_title="Retracted Video #4";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #4";		
	}
	elseif($_GET['video']==15)
	{
		$video_short_title="Retracted Video #5";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #5";		
	}
	elseif($_GET['video']==16)
	{
		$video_short_title="Retracted Video #6";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #6";		
	}
	elseif($_GET['video']==17)
	{
		$video_short_title="Retracted Video #7";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #7";		
	}
	elseif($_GET['video']==18)
	{
		$video_short_title="Retracted Video #8";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #8";		
	}
	elseif($_GET['video']==19)
	{
		$video_short_title="Retracted Video #9";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #9";		
	}
	elseif($_GET['video']==20)
	{
		$video_short_title="Retracted Video #10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video #10";		
	}
	elseif($_GET['video']=="flaccid")
	{
		$video_short_title="Flaccid Video 1 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 1 of 10";		
	}
	elseif($_GET['video']=="flaccid_2")
	{
		$video_short_title="Flaccid Video 2 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 2 of 10";		
	}
	elseif($_GET['video']=="flaccid_3")
	{
		$video_short_title="Flaccid Video 3 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 3 of 10";		
	}
	elseif($_GET['video']=="flaccid_4")
	{
		$video_short_title="Flaccid Video 4 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 4 of 10";		
	}
	elseif($_GET['video']=="flaccid_5")
	{
		$video_short_title="Flaccid Video 5 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 5 of 10";		
	}
	elseif($_GET['video']=="flaccid_6")
	{
		$video_short_title="Flaccid Video 6 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 6 of 10";		
	}
	elseif($_GET['video']=="flaccid_7")
	{
		$video_short_title="Flaccid Video 7 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 7 of 10";		
	}
	elseif($_GET['video']=="flaccid_8")
	{
		$video_short_title="Flaccid Video 8 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 8 of 10";		
	}
	elseif($_GET['video']=="flaccid_9")
	{
		$video_short_title="Flaccid Video 9 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 9 of 10";		
	}
	elseif($_GET['video']=="flaccid_10")
	{
		$video_short_title="Flaccid Video 10 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - Video 10 of 10";		
	}
	elseif($_GET['video']=="retracted")
	{
		$video_short_title="Retracted Video 1 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 1 of 10";		
	}
	elseif($_GET['video']=="retracted_2")
	{
		$video_short_title="Retracted Video =2 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 2 of 10";		
	}
	elseif($_GET['video']=="retracted_3")
	{
		$video_short_title="Retracted Video =3 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 3 of 10";		
	}
	elseif($_GET['video']=="retracted_4")
	{
		$video_short_title="Retracted Video 4 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 4 of 10";		
	}
	elseif($_GET['video']=="retracted_5")
	{
		$video_short_title="Retracted Video 5 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 5 of 10";		
	}
	elseif($_GET['video']=="retracted_6")
	{
		$video_short_title="Retracted Video 6 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 6 of 10";		
	}
	elseif($_GET['video']=="retracted_7")
	{
		$video_short_title="Retracted Video 7 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 7 of 10";		
	}
	elseif($_GET['video']=="retracted_8")
	{
		$video_short_title="Retracted Video 8 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 8 of 10";		
	}
	elseif($_GET['video']=="retracted_9")
	{
		$video_short_title="Retracted Video 9 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 9 of 10";		
	}
	elseif($_GET['video']=="retracted_10")
	{
		$video_short_title="Retracted Video 10 of 10";
		$video_long_title="DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - Video 10 of 10";		
	}
else
{
	$video_short_title="no video selected";
	$video_long_title="no video selected";		
}
...
function login($conn) {
	...
	$sql=$conn->prepare("SELECT* FROM video_clips WHERE email=:email AND clip=:clip");
	...
	if($count>0)
	{
		...
		{
			$the_date=$data['expiration_date'];				
		}
		$cutoffDate=strtotime($the_date);
		if($cutoffDate>$dday)
		{
			$_SESSION['auth'] = "yes";
			header("Location:video_display.php?video={$clip}");
			exit();
		}	
		else
		{
			header("Location:video_expired.php");
			exit();
		}
	}
	else
	{
		echo $cutoffDate;
		header("Location:video_login_wrong.php");
		exit ();	
	}	
}

require_once("support/adm/carter.inc");
   ...
   <div id='nomas_content'>
      ...
      <div id='nomas_page_headlines'>
       ...
       <div id='column_left_wide'>
          ...
          <div class='l_item'>
              <div class="heading">
                <h1><?php echo $video_long_title;?></h1>
              </div>
              <div class="reg_text">
			  Welcome!
			  <br><br>
			  To view "<?php echo $video_short_title;?>," enter your email and the password you were sent below and click, "Submit."
			  <br><br>
			  If you have any questions or need assistance, please contact NOMAS<sup>&reg;</sup> by clicking <a href="contact.php">here</a>.
			  <br><br>
			  Thanks!
			  <br><br>
			  <div style="width:45%; height:auto; text-align:center; border: 1px solid #cccccc; margin:auto; padding:15px; border-radius:10pt; box-shadow:5px 5px 3px #cccccc;">
				<table width=100% class="center"><form action="video_login.php?video=<?php echo $_GET['video'];?>" method="post">
					<tr>
