      ...
      <div id='nomas_page_headlines'>
       ...
       <div id='column_left_wide'>          
          ...
          <table style='margin-left:auto;margin-right:auto;'> 
			<tr>
				<td class="pageSubTitle"><u>Talk #2</u></td>
			</tr>
			<tr>
				<td>&nbsp;<br><br></td>
			</tr>
			<tr>
				<td class="videoCell">Talk #2 Handout: click <a href="http://www.nomasinternational.org/olceu/olceu_pdf/od1_talk_two.pdf" target="_blank" style="font-family:Arial, sans-serif; font-size:10pt; font-weight:bold; color:#333; text-decoration:underline;">here</a> to view the handout for Talk #2</td>
			</tr>
			<tr>
				<td>&nbsp;<br></td>
			</tr>
			<tr>
				<td class="videoCell">Talk #2 Video...<br><br></td>
			</tr>
             <tr>
                <td>
                   <div id='vidBox_2' style='color:red;'>Please install the Flash Plugin</div>	
                      <script type="text/javascript">
                    
                      jwplayer('vidBox_2').setup({
                         'id': 'playerID',
                         'width': '640',
                         'height': '520',
                         'file': 'http://www.nomasinternational.org/_video/od1_talk_two.mp4',
                         'provider': 'http',
                         'image': '',
			...
			<tr>
				<td>
					<table style="width:100%;">
						...
						<tr>
							<td class="videoCell" style="text-align:left;"><a href="series_four_video.php?the_sid=<?php echo $_GET['the_sid'];?>&the_at=<?php echo $_GET['the_at'];?>" style="color:#000000; text-decoration:none;"><span style="font-size:18px;">&#9668;</span>&nbsp;Talk #1</a></td>
							<td class="videoCell" style="text-align:right;"><a href="series_four_video_3.php?the_sid=<?php echo $_GET['the_sid'];?>&the_at=<?php echo $_GET['the_at'];?>" style="color:#000000; text-decoration:none;">Talk #3</a>&nbsp;<span style="font-size:18px;">&#9658;</span></td>
						</tr>
						<tr>
							<td colspan="2"><hr></td>
						</tr>
