      ...
      <div id='nomas_page_headlines'>
       ...
       <div id='column_left_wide'>          
          ...
          <table style='margin-left:auto;margin-right:auto;'> 
			<tr>
				<td class="pageSubTitle"><u>Talk #4</u></td>
			</tr>
			<tr>
				<td>&nbsp;<br><br></td>
			</tr>
			<tr>
				<td class="videoCell">Talk #4 Handout: click <a href="http://www.nomasinternational.org/olceu/olceu_pdf/od1_talk_four.pdf" target="_blank" style="font-family:Arial, sans-serif; font-size:10pt; font-weight:bold; color:#444; text-decoration:underline;">here</a> to view the handout for Talk #4</td>
			</tr>
			<tr>
				<td>&nbsp;<br></td>
			</tr>
			<tr>
				<td class="videoCell">Talk #4 Video...<br><br></td>
			</tr>
             <tr>
                <td>
                   <div id='vidBox_4' style='color:red;'>Please install the Flash Plugin</div>	
                      <script type="text/javascript">
                    
                      jwplayer('vidBox_4').setup({
                         'id': 'playerID',
                         'width': '640',
                         'height': '520',
                         'file': 'http://www.nomasinternational.org/_video/od1_talk_four.mp4',
                         'provider': 'http',
                         'image': '',
			...
			<tr>
				<td>
					<table style="width:100%;">
						...
						<tr>
							<td class="videoCell" style="text-align:left;"><a href="series_four_video_3.php?the_sid=<?php echo $_GET['the_sid'];?>&the_at=<?php echo $_GET['the_at'];?>" style="color:#000000; text-decoration:none;"><span style="font-size:18px;">&#9668;</span>&nbsp;Talk #3</a></td>
							<td class="videoCell" style="text-align:right;"><a href="series_four_video_5.php?the_sid=<?php echo $_GET['the_sid'];?>&the_at=<?php echo $_GET['the_at'];?>" style="color:#000000; text-decoration:none;">Talk #5</a>&nbsp;<span style="font-size:18px;">&#9658;</span></td>
						</tr>
						<tr>
							<td colspan="2"><hr></td>
						</tr>
