...
$pageTitle    = "Add a new NOMAS<sup>&reg;</sup> Practitioner";
$pageSubTitle = "Click 'Save Entry' to preserve, 'Cancel Entry' to quit without saving. <strong>Be sure NOMAS License number and Cert Year are correct.</strong>";
$errorMsg     = array();
...
$newnum = getNewMemNum(); // get highest existing license number and add 1
$newnum = ($newnum == '01') ? $thisYear .'01' : $newnum;

// vars for practitioners
$id           = (isset($_POST["id"])           && !empty($_POST["id"]))           ? $_POST["id"]           : "";
$cert_num     = (isset($_POST["cert_num"])     && !empty($_POST["cert_num"]))     ? $_POST["cert_num"]     : $newnum;
$cert_year    = (isset($_POST["cert_year"])    && !empty($_POST["cert_year"]))    ? $_POST["cert_year"]    : $thisYear;
...
if(isset($_REQUEST['ok']) && $_REQUEST['ok'] == 1) {
   if(isset($_REQUEST['lname']) && !empty($_REQUEST['lname']) && isset($_REQUEST['cert_num']) && !empty($_REQUEST['cert_num']) ) {	   
	  $okMsg = $_REQUEST['lname'] . " (Certificate " . $_REQUEST['cert_num'] . ") added OK!&nbsp; Add another practitioner below or to end, <a href='" . $membersList . "'>click here</a>.";
   }
}      

// Cancel ops
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['cancel'])) {
  header("Location: $homeMenuPage");
  exit;
}    
...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['submit'])) {
   $_POST['license'] = (isset($_POST['license'])) ? 1 : 0;
      $redir = $membersAdd . "?ok=";             
      $errorMsg = addMember($_POST, $redir);      
}  

$licChk = ($license == '1') ? "checked='checked'" : "";    
?>
<!DOCTYPE html>
<html>
<head>
...
<div id="playground">
  ...
  <div id='nav_box'>
    ...
    <div id='content'>
       ...
       <form id="form_members" action='<?php echo "{$_SERVER['PHP_SELF']}"?>' method="POST" accept-charset="utf-8" novalidate />
    
       <input name="id" type="hidden" value="<?php echo $id ?>">  
       
       <label for='cert_year'>Cert Year:</label>
       <input name="cert_year" type="text" value="<?php echo $cert_year ?>" size="10" maxlength="4">             
       ...
       <input name="fname" type="text" value="<?php echo $fname ?>" size="30" maxlength="50">          
            
       <label for='lname'>Last name:</label>
       <input name="lname" type="text" value="<?php echo $lname ?>" size="30" maxlength="50">                        
       
       <label for='addr1'>Address 1:</label>
       <input name="addr1" type="text" value="<?php echo $addr1 ?>" size="30" maxlength="100">

       <label for='addr2'>Address 2:</label>
       <input name="addr2" type="text" value="<?php echo $addr2 ?>" size="30" maxlength="100">           
       
       <label for='city'>City:</label>
       <input name="city" type="text" value="<?php echo $city ?>" size="30" maxlength="50"><br>  
       ...
       <select required name="country"> 
        ...
        <?php $country = $_POST['country'] = $_POST['selected']; ?>		                    
       ...
       <?php $state = $_POST['state'] = $_POST['selected']; ?>
       
       <label for='region'>Foreign Region (NON-USA):</label>
       <input name="region" type="text" value="<?php echo $region ?>" size="30" maxlength="50">          
            
       <label for='postal'>Postal Code:</label>
       <input name="postal" type="text" value="<?php echo $postal ?>" size="30" maxlength="15">     
       
       <label for='email'>Email:</label>
       <input name="email" type="text" value="<?php echo $email ?>" size="80" maxlength="100">    
       
       <label for='phone'>Phone:</label>
       <input name="phone" type="text" value="<?php echo $phone ?>" size="30" maxlength="20">    
       
       <label for='discipline'>Discipline:</label>
       <input name="discipline" type="text" value="<?php echo $discipline ?>" size="30" maxlength="255">                             
