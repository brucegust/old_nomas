    ...
    <div id='content'>
	   ...
	   ?>     
        ...
        <form id="form_members" action='<?php echo "{$_SERVER['PHP_SELF']}"?>' method="POST" accept-charset="utf-8" novalidate />
           ...
           <label for="license">License valid?</label>
           ...
           <select name="country"> 
            ...
            <input name="phone" type="text" value="<?php echo $phone ?>" size="20" maxlength="20">    
            ...
            <button type="submit" name="submit" value="submit">Save Changes</button><br>  
            <button type="submit" name="cancel" value="submit">Cancel Changes / Return to Main List</button><br>           
            <button type="submit" name="nuke" class="red_button" value="submit">Permanently Delete This Licensee</button><br>  
