...
// To here (and also echo $locfromroot; and ?cursess=<?php echo session_id(); below
?>
...
<head runat="server">
    ...
    <script  type="text/javascript">
        var base = "<?php echo $locfromroot; ?>"; /*Relative to Root*/
//        var base = "/LiveEditor/images"; /*Relative to Root*/
        ...
        function panelUpload() {
            ...
            $("#File1").uploadify({
                ...
                'script': 'server/upload.php?cursess=<?php echo session_id(); ?>',
