...
$sendToWho       = "PETER"; // PUNKY or PETER
...
// JQuery meta links
$jq_google        = '<script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>';
$jq_ui            = '<script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>';
$jq_ui_themes     = '<link rel="stylesheet" href="http://code.jquery.com/ui/1.10.1/themes/base/jquery-ui.css" />';
...
global $loginTBL, $activityTBL, $homeMenuPage, $loginPage, $u_lvl_min, $u_lvl_max, $today, $pw_salt;
  ...
  if(!$result = mysqli_query($link,$sql))
     return "Activity storage problem";
