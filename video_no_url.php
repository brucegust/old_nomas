       ...
       <div id='column_left_wide'>
          ...
          <div class='l_item'>
              <div class="heading">
				...
				<div class="reg_text">
				You're missing the video code that connects you to the specific practice video you want to view. Contact NOMAS for additional help by clicking <a href="contact.php">here</a>.
				<br><br>
				Thanks!
              </div>
