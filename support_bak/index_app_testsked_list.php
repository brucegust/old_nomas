...
$pageSubTitle = "Click Name to edit individual test information. Click column headers below, to sort. To delete, check box and confirm at page bottom. 
...
if(isset($_REQUEST['sid'])) {
  ...
  $pageTitle = $pageTitle . " For Test " . $sid . $sid_msg;
}
  ...
  <div id='content'>
      ...
      if(!is_object($showSked) || mysqli_num_rows($showSked) == '0') {
          ...
          if(isset($errorMsg) && count($errorMsg)) {
             echo "<tr><td colspan='9'><div class='error_msg'>";
          ...
          if(isset($errorMsg) && count($errorMsg) > 0) {
             echo "<table class='member_table'>\n";		  
             echo "<tr><td colspan='8'><div class='error_msg'>";
             foreach($errorMsg as $val) {
                echo $val . "<br>";
             }
		  ...
		  // includes jquery tablesorter - 9 COLUMNS
          echo "<table id='myTable' class='member_table'>\n";		  
		  echo "<THEAD>\n";
          echo "<tr>";
          echo "<th width='15%'>Name</th>";
          echo "<th width='10%'>Test Num</th>";
          echo "<th width='20%'>Email</th>";
          echo "<th width='12%'>Week Begins</th>";
          echo "<th width='12%'>Window Opened</th>";
          echo "<th width='12%'>Window Closed</th>";
          echo "<th width='8%'>DELETE</th></tr>\n"; 
		  echo "</THEAD>\n";
          ...
          while ($row = mysqli_fetch_assoc($showSked)) {
            ...
            echo "<td width='10%' class='ctr'>&nbsp;&nbsp;&nbsp;"  . $testnum . "</td>";				
            echo "<td width='20%'>"  . $email . "</td>";
            echo ($weekopen == '') ? "<td width='12%'>&nbsp;</td>"  : "<td width='10%'>"  . $weekopen . "</td>"; 
            echo ($winopen == '') ? "<td width='12%'>NOT STARTED</td>"  : "<td width='10%'>"  . $winopen . "</td>"; 
            echo ($winclose == '')   ? "<td width='12%'>NOT FINISHED</td>"  : "<td width='10%'>"  . $winclose   . "</td>";
            echo "<td width='8%'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='checkbox' name='del_me[]' value=$mid></td>";			 
            echo "</tr>\n";	
          } // end while
		  echo "</TBODY>\n";     		  
