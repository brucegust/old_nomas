...
{
	header("Location: video_login.php?video={$video}");
	exit();
}
   ...
   <div id='nomas_content'>
      ...
      <div id='nomas_page_headlines'>
       ...
       <div id='column_left_wide'>
		  ...
		  <!-- group flaccid and retractable videos -->
		  ...
		  <div class='l_item'>
              <div class="heading">
				...
				<div style="width:95%; height:auto; margin-left:12px;"><div class="reg_text">
				  Hello and Welcome!
				  <br><br>
				  You've been given access to every "<?php echo $video_text;?>" video. To view the videos, hit the "play" button and then navigate to either the next video or the previous video by using the two links at the bottom of the video screen. If you have any questions, please contact NOMAS<sup>&reg;</sup> by clicking <a href="contact.php" style="color:#000; text-decoration:underline;">here</a>.
				<br><br>
				  </div></div>
				  <br><br>
							...
							<tr>
								<td><br>
									<div class="reg_text" style="margin-left:-80px;">
										...
										{
										?>	
											click <a href="video_display.php?video=<?php echo $video_link_back;?>">here</a> to view previous video...
										<?php
										}
										?>
									</div>
								...
								<td style="text-align:right;"><br>
									<div class="reg_text">
										<?php 
											...
											{
											?>	
												click <a href="video_display.php?video=<?php echo $video_link_forward;?>">here</a> to view next video...
											<?php
											}
											?>
										</div>
		  ...
		  <!-- end group flaccid and retractable videos -->
			  ...
			  ?>
                 ...
                 <!--VIDEO-->
                  <div style='width:40%;float:left;display:inline;'>
                     ...
                     'height': '240',
                     'file': '_video/<?php echo $video_file;?>',
                     'image': '_video/video_title_slide_1.jpg',
                     'skin': '',
                     'controlbar.position': 'bottom',
                     'modes': [     
                        {type: 'html5'},								
                  ...
                  <!--END VIDEO-->
			  <div style='width:55%;float:left;display:inline;margin-left:12px;'><div class='reg_text'>Hello and Welcome!
			  <br><br>
			  <span style="font-weight:bold;">You're getting ready to watch, <?php if($_GET['video']<=10) { ?>
			  "DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH FLACCID TONGUE - <?php echo $video_title;?>!"<?php } else { ?>DIAGNOSIS: DYSFUNCTIONAL SUCK PATTERN WITH RETRACTED TONGUE - <?php echo $video_title;?>!<?php } ?> If you have any questions, please contact NOMAS<sup>&reg;</sup> by clicking <a href="contact.php" style="color:#000; text-decoration:underline;">here</a>.
			  <br><br>
			  Thanks!</span>
