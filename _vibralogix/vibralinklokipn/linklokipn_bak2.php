...
$PaypalEmail     = "marjorie@successfulfeeding.com";     // PRIMARY Paypal email address
...
$CopyEmail       = "peterbe@verizon.net";                // Receive copy of order emails
...
function EmailTemplateProcess($mailBody, $ProdId, $ProdDesc, $ProdLink, $ProdSize, $ProdExp, $ProdFile, $ProdExtra, $nd, $ext)
{
  ...
  if ($CopyEmail != "")
  {
    $subject = "Copy of Linklok Paypal email sent to $payer_email for order $invoice";
