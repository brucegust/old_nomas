...
<form name="sitelokregisteruser" action="register.php" method="POST">
<?php registeruser("CLIENT","0","/members/registerthanks.php","newuser.htm","newuseradmin.htm","Yes","YNYYYY"); ?>
Name<br>
