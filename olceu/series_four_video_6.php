...
<div id="playground">
  ...
  <tr>
				<td class="pageSubTitle"><u>Talk #6</u></td>
			</tr>
			<tr>
				<td>&nbsp;<br><br></td>
			</tr>
			<tr>
				<td class="videoCell">Talk #6 Handout: click <a href="http://www.nomasinternational.org/olceu/olceu_pdf/od1_talk_six.pdf" target="_blank" style="font-family:Arial, sans-serif; font-size:10pt; font-weight:bold; color:#666; text-decoration:underline;">here</a> to view the handout for Talk #6</td>
			</tr>
			<tr>
				<td>&nbsp;<br></td>
			</tr>
			<tr>
				<td class="videoCell">Talk #6 Video...<br><br></td>
			</tr>
             <tr>
                <td>
                   <div id='vidBox_6' style='color:red;'>Please install the Flash Plugin</div>	
                      <script type="text/javascript">
                    
                      jwplayer('vidBox_6').setup({
                         'id': 'playerID',
                         'width': '660',
                         'height': '620',
                         'file': 'http://www.nomasinternational.org/_video/od1_talk_six.mp4',
                         'provider': 'http',
                         'image': '',
			...
			<tr>
				<td class="videoCell" style="text-align:center;"><span style="text-align:center; font-weight:bold; color:red;">Be sure to take the quiz for CEU credit!</span><br><br><div style="width:300px; height: auto; padding:5px; margin:auto; border-radius:5pt; background-color:red; color: #ffffff; font-weight:bold;">Click <a href="http://www.nomasinternational.org/olceu/index_quiz.php?id=od1&sid=<?php echo $_GET['the_sid'];?>&qt=qtv&at=<?php echo $_GET['the_at'];?>" style="color:#ffffff; text-decoration:underline; font-weight:bold;">here</a> to take the quiz!</div></td>
			</tr>
			<!--
			<tr>
				<td class="videoCell" style="text-align:center;"><span style="text-align:center; font-weight:bold; color:red;">Be sure to take the quiz for CEU credit!</span><br><br><div style="width:300px; height: auto; padding:5px; margin:auto; border-radius:5pt; background-color:red; color: #ffffff; font-weight:bold;">Click <a href="http://www.nomasinternational.org/olceu/_docs/ONLINE_quiz.pdf" style="color:#ffffff; text-decoration:underline; font-weight:bold;">here</a> to take the quiz!</div></td>
			</tr>
			-->
			<tr>
				<td>&nbsp;<br><br></td>
			...
			<tr>
				<td>
					<table style="width:100%;">
						...
						<tr>
							<td class="videoCell" style="text-align:left;"><a href="series_four_video_5.php?the_sid=<?php echo $_GET['the_sid'];?>&the_at=<?php echo $_GET['the_at'];?>" style="color:#000000; text-decoration:none;"><span style="font-size:18px;">&#9668;</span>&nbsp;Talk #5</a></td>
							<td class="videoCell" style="text-align:right;">&nbsp;</td>
						</tr>
						<tr>
							<td colspan="2"><hr></td>
						</tr>
